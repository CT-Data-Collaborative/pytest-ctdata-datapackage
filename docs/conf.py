# -*- coding: utf-8 -*-
#
# pytest-ctdata_datatest documentation build configuration file, created by
...
project = u'pytest-ctdata_datatest'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-ctdata_datatest Documentation',
     [author], 1)
]

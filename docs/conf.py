# -*- coding: utf-8 -*-
#
# pytest-ctdata_datapackage documentation build configuration file, created by
...
project = u'pytest-ctdata_datapackage'
copyright = u'2015, Sasha Cuerda'
author = u'Sasha Cuerda'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-ctdata_datapackage Documentation',
     [author], 1)
]
